        ...
        {obj?(<><p className={'hamburger'} onClick={()=>{
            ...
            <div className={'nav-button'}>
                ...
                {is_cr===true?(<><div  onClick={()=>{
                    navigate('/Classmates')}} className={'button '}>My Classmates</div>
                        </>):(<></>)}

                <div  onClick={()=>{navigate('/feedback')}} className={'button '}>Feedback</div>
                <div  onClick={()=>{navigate('/oldpaper')}} className={'button '}>Old Paper</div>
                <div  onClick={()=>{
                    navigate('/profile')}} className={'button '}>Profile</div>
                <div  onClick={()=>{localStorage.removeItem('token');localStorage.removeItem("login");navigate('/login')}} className={'button login-button'}>Logout</div>
            </div></>):(<div></div>)}
